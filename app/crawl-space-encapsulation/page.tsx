...
export default function CrawlSpaceEncapsulationPage() {
  return (
    ...
    >
      ...
      <ServiceSection
        title="Why Vented Crawl Spaces Fail in South Carolina's Climate"
      ...
      >
        <p>
          ...
          spores into your living areas. Building science research consistently shows that in humid
          climates like the Upstate, vented crawl spaces perform worse than sealed ones.
        </p>
      </ServiceSection>

      <ServiceSection title="What&apos;s Included in a Full Encapsulation">
        <BulletList
          items={[
      ...
      <ServiceSection title="Encapsulation vs. Vapor Barrier Only" className="bg-neutral">
        <p>
      ...
      <ServiceSection title="Crawl Space Encapsulation Cost in Greenville">
        <p>
      ...
      <ServiceSection title="Warranty Information" className="bg-neutral">
        <p>
