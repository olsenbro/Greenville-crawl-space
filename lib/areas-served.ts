...
export const cityAreas: CityArea[] = [
  {
    ...
    intro: [
      ...
      "We serve Simpsonville from the same Greenville-based team that covers all of Upstate SC — same-day scheduling available for inspections throughout the Golden Strip.",
    ],
    body: [
      ...
      "Because Simpsonville sits just minutes from downtown Greenville, our inspection team covers the entire city without the delays or subcontractor handoffs common with out-of-area companies. We inspect, quote, and perform encapsulation, mold treatment, joist repair, and dehumidifier installation throughout Simpsonville — from established neighborhoods near City Hall to new construction off Neely Ferry Road.",
      "If you smell mustiness in your Simpsonville home, notice higher-than-normal humidity indoors, or had a home inspection flag your crawl space, schedule a free inspection. Most full encapsulation projects in Simpsonville run $5,000–$9,000 depending on square footage and existing conditions — far less than the structural repairs that follow years of unchecked moisture.",
    ],
  ...
  },
  {
    ...
    description:
      "Crawl space encapsulation and repair in Greer, SC. Serving older railroad district homes and BMW corridor subdivisions. Free crawl space inspection.",
    ...
    intro: [
      ...
      "We encapsulate, repair, and dehumidify crawl spaces throughout Greer — from downtown's established streets to Tyger River area developments.",
    ],
    body: [
      ...
      "Our team provides free crawl space inspections throughout Greer with written, itemized quotes. Services include full encapsulation with 20-mil liners, commercial dehumidifier installation, mold treatment, floor joist sistering, and drainage systems where needed. Whether you own a historic home downtown or a five-year-old subdivision property, we address the moisture source — not just the symptoms.",
    ],
  ...
  },
  {
    ...
    description:
      "Crawl space encapsulation in Spartanburg, SC. Moisture control for historic homes and rolling-terrain drainage challenges. Free inspection.",
    ...
    intro: [
      ...
      "We provide encapsulation, mold treatment, and structural repair throughout Spartanburg, where humidity levels often exceed even Greenville's.",
    ],
    body: [
      ...
      "Spartanburg's humidity statistics are among the highest in the Upstate. Average relative humidity runs several points above Greenville throughout the year, and summer months push outdoor dew points high enough that unencapsulated crawl spaces routinely exceed 85% RH — the threshold where mold growth accelerates on organic materials. Penicillium and Aspergillus species are commonly found on joists in Spartanburg crawl spaces during our inspections.",
      ...
      "We serve all of Spartanburg County with the same services available in Greenville: free inspections, 20-mil vapor barrier encapsulation, vent sealing, commercial dehumidifier installation, mold remediation, floor joist repair, and interior drainage systems. Our written quotes itemize every component so Spartanburg homeowners know exactly what they're paying for before work begins.",
    ],
  ...
  },
  {
    ...
    description:
      "Crawl space encapsulation in Anderson, SC. Vapor barriers, mold treatment, and repair for rural homes and Lake Hartwell area properties. Free inspection.",
    ...
    intro: [
      ...
      "We serve Anderson and surrounding communities with full encapsulation, mold treatment, and structural repair.",
    ],
    body: [
      "Anderson County stretches from the urban core near Clemson Boulevard to genuinely rural properties where homes sit on acreage with well water, septic systems, and crawl spaces that may not have been entered in years. This diversity means our Anderson calls range from suburban encapsulation projects to complex repairs on older farmhouses where moisture has compromised structural members over decades.",
  ...
  },
  {
    ...
    description:
      "Crawl space encapsulation in Mauldin, SC. Replace failed builder-grade vapor barriers in 1980s–2000s neighborhoods. Free inspection.",
    ...
    intro: [
      ...
      "We replace failed barriers with professional 20-mil encapsulation systems throughout Mauldin and greater Greenville County.",
    ],
    body: [
      ...
      "Our Mauldin service area covers every neighborhood in the city limits and adjacent unincorporated Greenville County communities. We provide free inspections with photo documentation, itemized quotes, and warranty terms in writing. Most Mauldin encapsulation projects run $5,000–$9,000 for a complete system. Homes requiring mold treatment or joist repair before encapsulation may cost more — but addressing everything in one project prevents the repeat failures that come from partial fixes.",
    ],
  ...
  },
  {
    ...
    description:
      "Crawl space encapsulation in Taylors, SC. Moisture control for Blue Ridge foothill homes where elevation-driven humidity meets Piedmont clay. Free inspection.",
    ...
    intro: [
      ...
      "We serve Taylors and north Greenville County with full encapsulation, dehumidifier installation, and crawl space repair.",
    ],
    body: [
      ...
      "We provide free crawl space inspections throughout Taylors with same-week availability from our Greenville-based team. Services include full 20-mil encapsulation, vent sealing, Santa Fe and Aprilaire dehumidifier installation, mold treatment, floor joist sistering, and drainage systems for homes with recurring water intrusion. Written quotes break down every line item so Taylors homeowners can compare fairly and understand exactly what their project includes.",
    ],
